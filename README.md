...
* There are also commented test scripts available in the "examples" directory of the installation. These scripts include examples of all available calls as well as a couple of real-world-like scenarios.
